...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  openYouTubeLogin: () => ipcRenderer.invoke('youtube-music-open-login'),
  clearYouTubeLogin: () => ipcRenderer.invoke('youtube-music-clear-login'),
  getYouTubeCookiePath: () => ipcRenderer.invoke('youtube-music-get-cookie-path'),
  openSpotifyLoginWindow: (authUrl) => ipcRenderer.invoke('spotify-open-login', authUrl),
